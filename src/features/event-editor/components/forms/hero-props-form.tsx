import { TextField, TextareaField, SectionDivider, str } from '../form-primitives';
...
export function HeroPropsForm({ props, onChange, eventId }: FormProps) {
  ...
  return (
    <div className="space-y-3">
      ...
      <SectionDivider label="문구" />
      <TextareaField label="초대 문구" value={str(props, 'message')} onChange={(v) => set({ message: v })} placeholder={"저희 두 사람이 하나가 되는 날\n소중한 자리에 함께해 주세요"} rows={3} />
